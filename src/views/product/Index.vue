                                    ...
                                    <div class="tabs">
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li v-for="productImage in product.productImages "
                                      ...
                                      <div class="popup-product-main-image-box">
                                        <div v-for="productImage in product.productImages " :id="`tabb${productImage.id}`"
                                  ...
                                  <div class="popup-right-content">
                                    ...
                                    <div class="color-varient">
                                      <template v-for="groupProduct in product.group_products">
                                        <a v-for="color in groupProduct.colors" :style="`background:${color.title}`" class="color-name">
                                          <span>{{ color.title }}</span>
                                        </a>
                                      </template>
                                    </div>
